                        ...
                        <?php foreach ($data['tui'] as $pro): ?>
                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="<?php echo $pro->title ?>" src="<?php echo $pro->cover ?>-covermiddle"
                ...
                <div class="row no-margin">
                    <?php for ($i = 0; $i < 3; $i++): ?>
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="<?php echo $data['all'][$i]->title ?>"
                                         src="<?php echo $data['all'][$i]->cover ?>-covermiddle"
                                         data-echo="<?php echo $data['all'][$i]->cover ?>-covermiddle"/>
                                </div>
                                <div class="body">
                                ...
                                <div class="prices">
                                    <div class="price-current text-right">
                                        ￥<?php echo $data['all'][$i]->saleprice ?></div>
                                </div>
                                <div class="hover-area">
                                    <div class="add-cart-button">
                                        <a href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $data['all'][$i]->productid]) ?>"
                                           class="le-button">加入购物车</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="<?php echo $last->cover ?>">
                                <img alt="<?php echo $last->title ?>" src="<?php echo $last->cover ?>-coverbig"
                                     data-echo="<?php echo $last->cover ?>-coverbig"/>
                            </a>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider"
                                   data-slide="0" href="#slide1"><img alt="<?php echo $last->title ?>"
                                                                      src="<?php echo $last->cover ?>-picsmall"
                                                                      data-echo="<?php echo $last->cover ?>-picsmall"/></a>
                            </li>
                            <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider"
                                       data-slide="<?php echo $key + 1; ?>" href="#slide<?php echo $key + 2; ?>"><img
                                                alt="" src="<?php echo $pic ?>-picsmall"
                                                data-echo="<?php echo $pic ?>-picsmall"/></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
                    ...
                    <div class="prices text-right">
                        ...
                        <a href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $last->productid]) ?>"
                           class="le-button big inline">加入购物车</a>
                    </div>
                </div><!-- /.product-item-holder -->
            </div><!-- /.col -->
